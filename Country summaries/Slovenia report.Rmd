...
drad_country <- drad_complete %>%
  filter(Residence == 17) #Slovenia = 17

nrow(drad_country) #n = 320
...
#write.table(org_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Slovenia org membership.txt", sep = ",", quote = FALSE, row.names = TRUE)
...
#write.table(polact_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Slovenia political actions.txt", sep = ",", quote = FALSE, row.names = TRUE)
```
