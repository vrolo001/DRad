...
drad_country <- drad_complete %>%
  filter(Residence == 7) #France = 7

nrow(drad_country)# n = 329
...
#write.table(org_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/France org membership.txt", sep = ",", quote = FALSE, row.names = TRUE)
...
#write.table(polact_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/France political actions.txt", sep = ",", quote = FALSE, row.names = TRUE)
```
