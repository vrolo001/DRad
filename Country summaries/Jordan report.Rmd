...
drad_country <- drad_complete %>%
  filter(Residence == 13) #Jordan = 13

nrow(drad_country) #n = 210
...
#write.table(org_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Jordan org membership.txt", sep = ",", quote = FALSE, row.names = TRUE)
...
#write.table(polact_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Jordan political actions.txt", sep = ",", quote = FALSE, row.names = TRUE)
```
