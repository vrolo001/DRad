...
#write.table(org_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Italy org membership.txt", sep = ",", quote = FALSE, row.names = TRUE)
...
#write.table(polact_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Italy political actions.txt", sep = ",", quote = FALSE, row.names = TRUE)
```
...
favstats(Populism ~ as.factor(Sex), data = drad_sex)
```
