...
sum(is.na(drad_orgmemb)) #28 missing values

org1 <- summary(c(as.factor(drad_orgmemb$OrgMember_1)))
org2 <- c(summary(c(as.factor(drad_orgmemb$OrgMember_2))), 0)
org3 <-summary(c(as.factor(drad_orgmemb$OrgMember_3)))
org4 <- c(summary(c(as.factor(drad_orgmemb$OrgMember_4))), 0)
org5 <- c(summary(c(as.factor(drad_orgmemb$OrgMember_5))), 0)
org6 <- c(summary(c(as.factor(drad_orgmemb$OrgMember_6))), 0)
org7 <- c(summary(c(as.factor(drad_orgmemb$OrgMember_7))), 0)
...
#write.table(org_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Georgia org membership.txt", sep = ",", quote = FALSE, row.names = TRUE)
...
#write.table(polact_table, file = "C:/Users/Vania/Desktop/DRad/data and code/R/DRad/tables/Georgia political actions.txt", sep = ",", quote = FALSE, row.names = TRUE)
```
...
favstats(Deprivation_2 ~ as.factor(discrim_group), data = drad_discrim)
